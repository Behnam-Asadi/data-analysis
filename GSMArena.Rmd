...
mobile %>% drop_na(den_vs_water) %>% filter(den_vs_water == 'Less Dense') %>% select(company, device, price, year, announced, dim_length, dim_breadth, dim_thickness, weight) %>% head() %>% kable()
...
```{r}
# Finding correlation between battery capacity and weight of the phones
